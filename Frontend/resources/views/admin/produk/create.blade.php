      ...
      <div class="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm space-y-6">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="number" name="base_price" required placeholder="Contoh: 2000" class="w-full pl-10 pr-4 py-3 text-xs rounded-xl border border-slate-200 focus:border-sanggablue focus:outline-none bg-slate-50/50 text-sanggablue font-bold">
          </div>
        </div>
        <div>
